        ...
        return new CommandPanel(
                new Column(
                    ...
                    children:<Widget>[
                        ...
                        new Text("/" + title, style: new TextStyle(color: GameColors.highValueContent, fontFamily: "Inconsolata", fontWeight: FontWeight.w700, fontSize: 12.0, decoration: TextDecoration.none, letterSpacing: 0.9)),
                        new Container(height:1.0, decoration: new BoxDecoration(color:GameColors.lowValueContent), margin:new EdgeInsets.only(top:8.0, bottom:20.0)),
