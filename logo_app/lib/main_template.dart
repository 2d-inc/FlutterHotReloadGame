				...
				children: <Widget>[
					featuredRestaurantSize > 10 ? new Container(
						...
						child:new FeaturedCarousel(data:featuredRestaurants, 
													...
													cornerRadius: FEATURED_CORNER_RADIUS, 
													iconType:CAROUSEL_ICON_TYPE, 
					...
					const ListRestaurantSimple('Indian Food', 
												...
												padding:APP_PADDING, 
												showImage:HAVE_IMAGES, 
												showRating:SHOW_RATINGS, 
												showDeliveryTime: SHOW_DELIVERY_TIMES, 
												totalDollarSigns:DOLLAR_SIGNS, 
												isCondensed:CONDENSE_LIST_ITEMS, 
